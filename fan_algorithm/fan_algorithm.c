...
static int initial_fan_config(sd_bus *bus)
{
	...
	get_dbus_fan_parameters(bus, "FAN_LED_AUX_SPEED_LIMIT", &reponse_len, reponse_data);
	g_fanled_aux_speed_limit = reponse_len > 0? atoi(reponse_data[0]): g_fanled_speed_limit;
